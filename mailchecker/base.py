...
from .options import GmailOptions
# from .options2 import GmailOptions
...
class constructor(type):
    def __new__(cls, name, bases, attrs):
        ...
        attr_meta = attrs.pop('Meta', GmailOptions)
        if not attr_meta:
        ...
        # import pdb
        # pdb.set_trace()
        new_class.add_to_class('_meta', attr_meta(meta, app_label=app_label, the_class=new_class))
...
class GmailModel(with_metaclass(constructor)):
    _deferred = False
    _state = ModelState()
